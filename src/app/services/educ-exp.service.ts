...
editEducation( education:Education|number): Observable<Education>{
 ...
 return this.http.put<any>(`${this.apiUrl + '/education/edit'}/${id}`, education, httpOptions);
}
...
addExperience(experience:Experience): Observable<Experience>{
  return this.http.post<Experience>(this.apiUrl+"/experience/new",experience);
}
editExperience( experience:Experience|number): Observable<Experience>{
  const id =  typeof experience === 'number' ? experience : experience.id;
  return this.http.put<any>(`${this.apiUrl + '/experience/edit'}/${id}`, experience, httpOptions);
 }
